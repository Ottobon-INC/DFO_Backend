...
for (const file of envFiles) {
    ...
    try {
        ...
        for (const line of lines) {
            ...
            // Search for Supabase Service Role Key or general Supabase Keys
            if (trimmed.includes('SUPABASE_SERVICE_ROLE_KEY') || trimmed.includes('SUPABASE_KEY') || trimmed.includes('SUPABASE_SECRET') || trimmed.includes('SERVICE_ROLE_KEY')) {
